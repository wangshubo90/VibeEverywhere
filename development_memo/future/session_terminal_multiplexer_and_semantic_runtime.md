...
- the implementation-facing starting point is now:
  - [session_terminal_multiplexer_v1.md](session_terminal_multiplexer_v1.md)
  - [session_terminal_multiplexer_wire_compatibility.md](session_terminal_multiplexer_wire_compatibility.md)
