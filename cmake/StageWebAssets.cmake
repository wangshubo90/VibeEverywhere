...
if(NOT DEFINED SENTRITS_WEB_REVISION_FILE OR SENTRITS_WEB_REVISION_FILE STREQUAL "")
  message(FATAL_ERROR "SENTRITS_WEB_REVISION_FILE is required")
endif()
...
string(REPLACE "\"" "" SENTRITS_WEB_REVISION_FILE "${SENTRITS_WEB_REVISION_FILE}")
...
if(NOT EXISTS "${SENTRITS_WEB_REVISION_FILE}")
  message(FATAL_ERROR "Sentrits-Web revision file not found at ${SENTRITS_WEB_REVISION_FILE}")
endif()

file(READ "${SENTRITS_WEB_REVISION_FILE}" SENTRITS_WEB_REVISION_EXPECTED)
string(STRIP "${SENTRITS_WEB_REVISION_EXPECTED}" SENTRITS_WEB_REVISION_EXPECTED)
if(SENTRITS_WEB_REVISION_EXPECTED STREQUAL "")
  message(FATAL_ERROR "Sentrits-Web revision file ${SENTRITS_WEB_REVISION_FILE} is empty")
endif()
...
if(NOT SENTRITS_WEB_REVISION STREQUAL SENTRITS_WEB_REVISION_EXPECTED)
  message(FATAL_ERROR
    "Sentrits-Web checkout is at ${SENTRITS_WEB_REVISION}, expected ${SENTRITS_WEB_REVISION_EXPECTED} from ${SENTRITS_WEB_REVISION_FILE}")
endif()
